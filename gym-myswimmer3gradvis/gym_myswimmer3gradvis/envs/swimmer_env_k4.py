...
class MySwimmerGradVis4(gym.Env):
    def __init__(self):
        self.x_threshold = 50 # for the center of mass of the swimmer 
            ...
            if action==0:
                ...
                for _ in range(d):
                    ...
                    A = 1/(4 * math.pi * mu_1 * L1) \
                        - 1/(6 * math.pi * mu_2 * self.R) \
                        - 1/(6 * math.pi * mu_1 * self.R) \
                        + 1/(4 * math.pi * mu_2 * L1)

                    B = - 1/(6 * math.pi * mu_2 * self.R) \
                        + 1/(4 * math.pi * mu_3 * L2) \
                        + 1/(4 * math.pi * mu_2 * L1) \
